...
export default function TopTeachersCard(props: TopTeachersCardProps) {
  ...
  return (
    <Link
      href={routes.home()}
      className="flex flex-col h-full p-5 gap-2 bg-card border border-border hover:border-primary rounded-3xl justify-center items-center"
    >
      <Image
        src={imageSrc}
        alt={title}
